...
d3.select('#y2019').on('click', () => {
    ...
    page4TrendTitleFormat(div, '#DFB853', "SALES")
...
d3.select('#y2016').on('click', () => {
    ...
    let text = `2016<br><br>
    POP MART obtained the exclusive domestic
    authorization of the Molly series of Hong Kong designer
     Kenny Wong. Before collaborating with POP MART, Molly had been
      operating in Hong Kong for 10 years and had a group of die-hard fans. 
      It was launched in POP MART Tmall official store only In 4 seconds, 200 
      sets of limited-edition Molly products were sold out.`
    addAnimation(div, text, '2019')
...
d3.select('#y1980').on('click', () => {
    ...
    let text = `1980s<br><br>
        The concept of blind boxes originated in Japan in the 1980s. At that time, the "gashapon machine" that emerged was concentrated in the fields of two-dimensional, ACG and other fields. Blind box was originally called “mini figures”, and later called blind box.`
...
d3.select('#y2010').on('click', () => {
  ...
  He founded POP MART, and this business model of the blind box marketing will be implemented in China.
  `
...
d3.select('#y2021').on('click', (e) => {
    ...
    page4TrendTitleFormat(div, '#66AF60', "SOCAIL MEDIA")
